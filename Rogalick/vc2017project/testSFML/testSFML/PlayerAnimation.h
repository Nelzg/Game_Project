...
public:
	...
	void animation(sf::Clock clock) {
		...
		{
		case 0: {
			texture.loadFromFile("D:/PROJECTS_INFA/HomeWork_3_sem/Rogalick/bin/hero_animation/hero_1.png");
			break;
			}
		case 1: {
			texture.loadFromFile("D:/PROJECTS_INFA/HomeWork_3_sem/Rogalick/bin/hero_animation/hero_2.png");
			break;
		}
		case 2: {
			texture.loadFromFile("D:/PROJECTS_INFA/HomeWork_3_sem/Rogalick/bin/hero_animation/hero_3.png");
			break;
		}
		case 3: {
			texture.loadFromFile("D:/PROJECTS_INFA/HomeWork_3_sem/Rogalick/bin/hero_animation/hero_4.png");
			break;
		}
		case 4: {
			texture.loadFromFile("D:/PROJECTS_INFA/HomeWork_3_sem/Rogalick/bin/hero_animation/hero_1.png");
